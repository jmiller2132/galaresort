        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-5 space-y-2 text-sm text-white/60">
              <p>Fremont, WI</p>
              <p>RV Park: <a href="tel:+19204463222" className="hover:text-wood-light transition-colors">(920) 446-3222</a></p>
              <p>Bar: <a href="tel:+19204462423" className="hover:text-wood-light transition-colors">(920) 446-2423</a></p>
              <p><a href="mailto:galaresortllc@gmail.com" className="hover:text-wood-light transition-colors">galaresortllc@gmail.com</a></p>
            </div>
            <Link
              href="/contact"
              className="mt-4 text-sm transition-all duration-200 hover:text-wood-light hover:translate-x-0.5 inline-block"
            >
              Contact Us →
            </Link>
          </div>
