...
export const cabins: Cabin[] = [
  {
    ...
    amenities: ["Waterfront", "Private Pier", "Log Porch", "Patio Doors", "Loft Sleeping Area", "Furnished", "Cooking Utensils", "Microwave", "TV", "Central Air", "Central Heat", "River Views"],
    images: [
  ...
  },
  {
    ...
    amenities: ["Waterfront", "Private Master Bedroom", "Bunk Bedroom", "Loft Sleeping Area", "Living Room", "Dining Area", "Furnished", "Cooking Utensils", "Microwave", "TV", "Central Air", "Central Heat"],
    images: [
  ...
  },
  {
    ...
    amenities: ["Waterfront", "Two Bedrooms", "Full Kitchen", "Full Bath", "Living Room", "Dining Area", "Patio Doors", "Furnished", "Cooking Utensils", "Microwave", "TV", "Central Air", "Central Heat"],
    images: [
